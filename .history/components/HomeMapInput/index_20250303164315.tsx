...
export const HomeMapInput = ({
  ...
  const autocompleteRef = dataef<google.maps.places.Autocomplete | null>(null);
  const mapRef = dataef<google.maps.Map | null>(null);
  const geocoder = dataef<google.maps.Geocoder | null>(null);
