    ...
    <div className="flex flex-col mt-3 w-full relative">
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="space-x-3 flex items-center justify-center w-full">
          <button
            type="button"
            className="block mt-3 font-archivo z-[50] w-max max-w-full px-3 md:px-8 py-1.5 rounded-lg text-lg bg-[#CFACAC] text-white hover:bg-[#CFACAC]/90 disabled:bg-gray-300"
