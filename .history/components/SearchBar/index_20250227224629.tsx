...
export default async function SearchBar({ slugCity }: { slugCity: string }) {
  return (
    <>
      <div className="bg-woman bg-cover sm:bg-contain bg-no-repeat bg-red-800/90 w-full min-h-[50%] relative sm:py-12">
        <div className="border border-black bg-black/50 h-max w-max p-12 flex flex-col items-center justify-center text-center mx-auto">
