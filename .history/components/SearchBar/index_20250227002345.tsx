...
export default async function SearchBar({ slugCity }: { slugCity: string }) {
  return (
    <>
      <div className="bg-woman bg-contain bg-no-repeat bg-blue-400/70 w-full min-h-[50%] relative">
        <div className="h-full w-full bg-black/40 p-12 py-24 flex flex-col">
