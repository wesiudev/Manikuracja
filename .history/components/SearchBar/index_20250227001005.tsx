...
export default async function SearchBar({ slugCity }: { slugCity: string }) {
  return (
    <>
      <div className="bg-woman bg-contain bg-no-repeat w-full min-h-[50%] rounded-xl relative">
        <div className="h-full w-full bg-black/50 p-12 py-60 rounded-xl flex flex-col">
