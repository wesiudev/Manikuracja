  ...
  return (
    <div className="flex flex-col mt-3 w-full relative">
      <div className="flex flex-col items-center justify-center">
        <div className="relative h-max flex flex-row items-center justify-center">
          <div className="p-2 absolute left-[-46px] top-0 h-12 aspect-square rounded-l-lg bg-[#CFACAC]">
          ...
          <input
            ...
            className="text-center rounded-md md:min-w-[350px] max-w-[450px] bg-[#8F5B6A] placeholder:text-white z-[91] block px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-400"
            autoComplete="off"
        ...
        <button
          type="button"
          className="block mt-3 font-archivo z-[50] w-max max-w-full px-8 py-1.5 rounded-lg text-lg bg-[#CFACAC] text-white hover:bg-[#CFACAC]/90 disabled:bg-gray-300"
          onClick={search}
        >
          SZUKAJ
        </button>
