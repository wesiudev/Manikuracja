    ...
    <div className="flex flex-col sm:flex-row gap-4 mt-3 w-full">
      <div className="relative w-full mt-6">
        ...
        <input
          ...
          className="bg-black/50 placeholder:text-white z-[91] block mt-1 w-full sm:max-w-[300px] px-2 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-400"
          autoComplete="off"
