      ...
      <div className="flex flex-col items-center justify-center">
        <div className="relative h-max flex flex-row items-center">
          ...
          <input
            ...
            className="text-center rounded-md min-w-[400px] max-w-[450px] bg-[#8F5B6A] placeholder:text-white z-[91] block px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-400"
            autoComplete="off"
