    ...
    <div className="flex flex-col mt-3 w-full relative">
      <div className="flex flex-col items-center justify-center">
        <input
          ...
          className="mt-3 max-w-[350px] bg-black/50 placeholder:text-white z-[91] block sm:max-w-1/2 px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-red-800"
          autoComplete="off"
