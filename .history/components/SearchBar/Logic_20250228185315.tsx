  ...
  return (
    <div className="flex flex-col mt-3 w-full relative">
      <div className="flex flex-col items-center justify-center">
        <div className="h-full aspect-square rounded-l-lg bg-[#CFACAC]">a</div>
        <input
          type="text"
          name="city"
          value={city.name}
          ...
          className="rounded-md mt-3 max-w-[450px] bg-[#8F5B6A] placeholder:text-white z-[91] block px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-400"
          autoComplete="off"
