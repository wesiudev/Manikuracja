  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 mt-3 w-full">
      <div className="relative w-full">
        <label
          htmlFor="city"
          className="bg-red-800/70 px-[1rem] py-[0.4rem] block w-max text-white text-lg font-bold"
        >
          Miasto
        </label>
        <input
          ...
          className="bg-black/50 placeholder:text-white z-[91] block mt-1 w-full px-2 py-2 text-black focus:outline-none focus:ring-2 focus:ring-red-800"
          autoComplete="off"
