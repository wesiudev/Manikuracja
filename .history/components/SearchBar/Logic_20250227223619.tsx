    ...
    <div className="flex flex-col mt-3 w-full relative">
      <div className="flex flex-col items-center justify-center">
        <input
          ...
          className="mt-4 max-w-[300px] bg-black/50 text-lg placeholder:text-white z-[91] block sm:max-w-1/2 px-2 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-400"
          autoComplete="off"
        ...
        <button
          type="button"
          className="block font-archivo z-[50] w-max max-w-full px-6 text-lg bg-red-600 text-white hover:bg-red-700 disabled:bg-gray-300"
          onClick={search}
        >
          SZUKAJ
        </button>
