...
export default function HowItWorks() {
  ...
  return (
    <div className="bg-white font-sans h-max py-12 w-full lg:min-h-[60vh] px-3 md:px-8  xl:px-32 ">
        ...
        <div className="flex flex-col lg:space-y-3 pl-3 lg:px-6 lg:mt-0">
          {howItWorks.map((item: any, i: number) => (
            <button
              ...
              } duration-200 p-5 lg:p-3 aspect-square lg:aspect-auto lg:rounded-xl justify-center bg-blue-400 text-2xl text-white drop-shadow-xl shadow-black flex flex-row items-center lg:justify-between`}
            >
