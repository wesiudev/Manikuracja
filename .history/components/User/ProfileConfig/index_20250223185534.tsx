...
export default function ProfileConfig() {
  ...
  return (
    <div
      className={`z-[92] flex p-6 lg:p-12 xl:p-40 2xl:p-64 !py-6 lg:!py-12 xl:!py-24 w-full`}
    >
      <div
        onClick={(e) => {
          e.stopPropagation();
        }}
        className="h-max bg-white mx-auto p-6 rounded-xl shadow-sm shadow-zinc-800"
      >
