      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-[1rem]">
        ...
        >
          <div className="flex flex-row justify-between items-start w-full">
            ...
            <div
              className={`relative flex items-center justify-center border-white rounded-full h-5 w-5 border-[2px]`}
            >
              <div
                className={`${
        ...
        <button
          ...
          className={`hover:bg-white bg-gray-200 duration-300 p-3 flex flex-col py-5 border border-white ${
            seek &&
            "bg-[#46829c27] shadow-[#46829cc5] shadow-sm border-[#126b91]"
          }`}
        >
          <div className="flex flex-row justify-between items-start w-full">
            ...
            >
              ...
              <div
                className={`${
                  seek && "border duration-75 border-white"
                } bg-white w-2.5 h-2.5 rounded-full absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2`}
              ></div>
            </div>
          </div>
