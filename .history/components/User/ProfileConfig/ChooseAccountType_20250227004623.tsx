    ...
    <div className="flex flex-col justify-center items-center h-full">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-[1rem]">
        ...
        <button
          ...
          className={`rounded-lg hover:bg-[#46829c27] hover:shadow-sm hover:shadow-[#46829cc5] bg-white duration-300 p-3 flex flex-col py-5 border-gray-500 border hover:border-[#126b91] ${
            seek &&
            "bg-[#46829c27] shadow-[#46829cc5] shadow-sm border-[#126b91]"
          }`}
        >
          <div className="flex flex-row justify-between items-start w-full">
            ...
            >
              <div
                className={`${
                  seek && "border-[10px] duration-75 border-red-500"
                } w-0 h-0 bg-[#126b91] rounded-full`}
              ></div>
              <div
                className={`${
