...
export default async function Home() {
  return (
    <>
      ...
      <div className="bg-[bg-[#E7C1C6]"></div>
      <div className="h-screen w-full lg:w-3/4 mx-auto bg-[#CFACAC] flex flex-col items-center justify-center text-center lg:flex-row lg:justify-between">
        <Image
          src={image1}
          width={1024}
          height={1024}
