...
export default async function Home() {
  return (
    <div>
      ...
      {/* Highlights Section */}
      <div>
        <div className="mt-3 rounded-lg p-6 py-12 bg-white lg:flex lg:flex-col lg:items-center lg:justify-center">
          <div>
            <Image
              src={heroimage}
              width={1024}
          ...
          <div className="mt-4 flex flex-col-reverse max-w-4xl mx-auto">
            <h1 className="text-2xl md:text-4xl font-bold text-center text-zinc-800 drop-shadow-sm shadow-black">
