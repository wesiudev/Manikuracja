...
export default async function Home() {
  return (
    <>
      ...
      <div className="h-screen w-full lg:px-24 mx-auto bg-[#CFACAC] flex flex-col items-center justify-center text-center lg:flex-row lg:justify-between">
        <Image
          src={image1}
          width={1024}
          height={1024}
        ...
        />
        <div className="">
          <h2 className="font-tenor text-4xl lg:text-6xl lg:max-w-3/4">
