      ...
      <div>
        <div className="mt-3 rounded-lg p-6 py-12 bg-white">
          <div className="flex flex-col-reverse max-w-4xl mx-auto">
            <h1 className="text-2xl md:text-4xl font-bold text-center text-zinc-800 ">
              Pobierz aplikację Manikuracja, paznokcie w Twojej okolicy!
            </h1>
            <p className="text-center mb-3 text-gray-400 italic">
        ...
        <div className="py-12 p-6 bg-white mt-3 rounded-lg">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-center text-3xl lg:text-4xl font-bold text-zinc-800  mb-6">
              Popularne usługi
            </h2>
        ...
        <div className="py-12 p-6 bg-white mt-3 rounded-lg items-center justify-center flex flex-col text-center">
          <h2 className="text-zinc-800  text-3xl lg:text-4xl font-bold mb-4">
            Zacznij już dziś
          </h2>
        ...
        <div className="mt-3 p-6 bg-white rounded-lg w-full">
          <h2 className="text-3xl lg:text-4xl text-zinc-800  font-bold text-center mb-6">
